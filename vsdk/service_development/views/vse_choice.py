...
def choice_options_resolve_voice_labels(choice_options, language):
    ...
    for choice_option in choice_options:
        choice_options_voice_labels.append(
            choice_option.get_voice_fragment_url(language))
...
def choice_generate_context(choice_element, session):
    ...
    context = {'choice': choice_element,
               ...
               'choice_options_voice_labels': choice_options_resolve_voice_labels(
                   choice_options, language),
               'choice_options_redirect_urls': choice_options_resolve_redirect_urls(
                   choice_options, session),
               'language': language,
               }
    return context
